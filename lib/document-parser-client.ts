// Client-side document parser without Node.js dependencies
    ...
    try {
      ...
      switch (documentType) {
        case DocumentType.PDF:
          // For PDF, we'll send to server for parsing
          throw new Error('PDF parsing must be done on server side');
